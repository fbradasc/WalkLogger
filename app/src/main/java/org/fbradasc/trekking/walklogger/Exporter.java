...
import static org.fbradasc.trekking.walklogger.GPSApplication.getInstance;
...
class Exporter extends Thread {
    ...
    private final boolean exportPMK;
    ...
    public void run() {
        ...
        try {
            ...
            if (exportPMK) {
                OutputStream outputStream = GPSApplication.getInstance().getContentResolver().openOutputStream(pmkFile.getUri(), "rw");
                pmkBW = new BufferedWriter(new OutputStreamWriter(outputStream));
            }
            ...
            if (exportKML) {
                ...
                kmlBW.write(String.valueOf(track.getNumberOfLocations ()) + " Trackpoints<br>"        +
