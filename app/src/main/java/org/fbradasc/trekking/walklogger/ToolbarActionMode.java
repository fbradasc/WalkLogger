...
public class ToolbarActionMode implements ActionMode.Callback {
    ...
    private MenuItem menuItemPlacemarks;
    ...
    public boolean onPrepareActionMode(ActionMode mode, Menu menu) {
        ...
        menuItemPlacemarks = actionMenu.findItem(R.id.cardmenu_placemarks);
        menuItemPlacemarks.setShowAsAction(MenuItem.SHOW_AS_ACTION_ALWAYS);
        EvaluateVisibility();
        return true;
    }
    ...
    public void EvaluateVisibility() {
        if (GPSApplication.getInstance().getNumberOfSelectedTracks() > 0) {
            ...
            menuItemPlacemarks.setVisible(gpsApp.isContextMenuShareVisible());
